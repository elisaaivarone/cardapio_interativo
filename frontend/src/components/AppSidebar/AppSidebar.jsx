...
const AppSidebar = ({
  ...
  const goToSettings = () => navigate("/equipe");
  ...
  return (
    ...
    >
      ...
      <AppBar
        position="static"
        sx={{ display: { md: "none" }, bgcolor: "background.paper" }}
      >
        <Toolbar>
      ...
      >
        ...
        >
          ...
          {/* 2. Botão de PERFIL (Para TODOS: Admin, Garçom, Cozinha) */}
          <Button
            fullWidth
            startIcon={<GroupIcon />}
            onClick={goToSettings}
            variant={location.pathname === "/equipe" ? "contained" : "text"}
            color={location.pathname === "/equipe" ? "primary" : "inherit"}
            sx={{justifyContent: "flex-start", fontWeight: "bold", textTransform: "none" }}
          >
          Perfil
          </Button>
        </Box>
        <Divider sx={{ my: 1, width: "90%", alignSelf: "center" }} />
